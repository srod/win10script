...
$customInstall.location          = New-Object System.Drawing.Point(4,231)
...
$Panel3.controls.AddRange(@($yourphonefix,$Label6,$windowsupdatefix,$ncpa,$oldcontrolpanel,$oldsoundpanel,$Button1,$customInstall))
